...
-   **P-014 activates P-013 only.** It cannot be invoked for any other patch.
-   **P-014 closes permanently upon P-013 ACTIVE status.**
...
| 4 | P-011 (Narrative) | FAP | YES — CFRL publication gate |
...
| **Contract-commitment parameter values set** | P-023 | Reserved commitments FC-160 through FC-184 in Annex AR bound; EC demurrage calibration confirmed; inspector pool commissioned | Annex AR |
