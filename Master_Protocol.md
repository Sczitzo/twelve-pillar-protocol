...
This edition shall be maintained as a controlled corpus rather than a chain of disconnected drafts. The Master Protocol governs substantive system design; the Threat Register governs adversarial modeling; the Patch Log governs change history; the White Paper governs public explanation; and the Diagrammed Technical Reference governs structural visualization. No supporting document may contradict the Master Protocol. Conflicts resolve upward to the Master Protocol, then to the Patch Log for implementation history.

### AB2. T-001 Shadow Convertibility — Containment Architecture
The protocol does not attempt to eliminate all informal exchange. It prevents scalable arbitrage that would collapse the separation between survival access and market money.
- **Essential goods and services** accessible through LC shall be LC-only in the baseline lane. EC does not directly purchase the constitutional survival floor.
- **LC execution** shall be non-delegable by default except for narrowly scoped, logged, and reversible caregiver or dependent pathways.
- **LC balances** remain time-bounded and non-accumulative beyond the published continuity window to reduce stockpiling and arbitrage inventory.
...
- **Reward channels** shall remain multi-dimensional: EC-based optional access, civic-layer standing under bounded rules, and non-transferable recognition or role-access pathways.
...
- **No scale deployment** shall proceed without acceptable Sybil resistance, false-positive control, false-negative control, and recovery performance under live pilot evidence.

### AB5. T-007 Political Definition Drift — Semantic Anti-Capture System
Protected terms are constitutional objects. Capture often proceeds through semantics, standards, and technical reinterpretation rather than open repeal. The protocol therefore governs definitions as a live anti-capture layer.
- **Core terms** shall be classified by protection level. Constitutional terms such as survival, personhood, humane floor, non-convertibility, essential category, capacity, coercion, and scarcity shall not drift through operational relabeling.
- **Any change** that alters real access, eligibility, burden, continuity, quality floor, or reviewability is substantive regardless of whether it is labeled technical or clerical.
...
- T-002 / P-003 — Identity System Hardening
...
**Build integrity:** This revision is not a patch memo. It is a full working text built on the predecessor draft, with targeted insertions and clarifications integrated into the document body.

## THE HUMANE CONSTITUTION
**A constitution-grade architecture for a flow-based economy, unconditional survival, and capture-resistant governance.**

*Proposal 2 close-out (2026-04-18): the operational architecture was restructured from twelve pillars into a consolidated `v13` form first expressed as **Seven Pillars + P0**. The current public-facing constitutional presentation uses **one Founding Order** and **seven Articles of Constitutional Order**. The underlying structure is unchanged; the naming frame has been constitutionalized. Legacy **Twelve-Pillar Protocol**, `v12`, and `v13` shorthand references remain only for continuity and crosswalk traceability. §III below defines the current structure.*
...
- **Control layer:** Annexes A-C cover threats, threat operations, and readiness gates; Annexes G-I define change control, rights, residency, and review pathways.
- **Hardening layer:** Annexes J-Y close loopholes, specify transition, identity, issuance, and survival-floor mechanics, and add failure, anti-capture, and continuity safeguards.
...
The legacy system fails when financial claims on the future outgrow the physical reality of the present. This protocol treats money and power as constrained by measurable capacity, time, and accountability.
...
*Instrument-to-article mapping in the current presentation: **LC** lives in **Article IV (Survival)**, **EC** and **SQ** live in **Article V (Markets, Commons & Public Finance)**, and **DW** and **CR** live in **Article VI (Civic Layer & Deliberation)**. Historical v13 shorthand references to P4/P5/P6 survive only in legacy crosswalks and patch records.*
...
- **Nature:** LC is not money. It is a non-transferable entitlement ledger that authorizes access to the essential basket.
- **Constitutional floor:** LC may never be narrowed below the Constitutional Survival Minimum defined in Annex Y, even when the broader essential basket is under review or temporary substitution is required.
- **Cycle rule:** LC is issued as a daily micro-allocation derived from the weekly baseline, with each daily tranche valid for 72 hours; this smooths demand, limits hoarding, and avoids single-day expiry cliffs.
- **Protection rule:** LC cannot be sold, pledged, collateralized, or informally monetized; narrow caregiver/dependent exceptions must remain capped, auditable, and reversible when coercion appears.

### 3) Civic Layer (DW + CR) - Deliberation & Service
- **Purpose:** the civic layer is split into two bounded instruments. Deliberation Weight (DW) governs short-horizon agenda-setting and budget prioritization; Civic Record (CR) governs eligibility to serve on juries, panels, rotating review bodies, and oversight roles.
- **Nature:** neither DW nor CR is money. Both remain non-transferable, non-convertible, and narrow in function. DW is fast-decay and low-cap; CR is slower-moving and service-oriented. Earlier references to “CC” should be read as the umbrella civic layer unless a section explicitly distinguishes DW from CR.
- **Anti-capture rule:** DW may never purchase goods, private privilege, legal immunity, or survival access, and CR may never be traded, inherited, collateralized, or pooled as a patronage asset. Survival-adjacent decisions remain protected by one-person-one-vote legitimacy checks, and no single contribution sector may dominate effective civic weighting.

### 4) Scarcity Quotas (SQ) - The Emergency Brake
- **Purpose and limit:** SQ is a temporary, category-specific emergency quota instrument activated only during verified scarcity. SQ is not money, is not permanent, is non-convertible, and must terminate when scarcity mode ends.
- **Separation rule:** EC is the only true currency. LC, the civic layer (DW and CR), and SQ are not money and may not be converted, pooled, sold, wrapped, or re-created through indirect markets, queue trading, or proxy contracts.

---

## III. Founding Order and Articles of Constitutional Order

**Proposal 2 close-out, 2026-04-18.** This section preserves the substantive v13 restructuring while presenting the live architecture in a more constitutional voice. The current architecture consists of **one Founding Order** and **seven Articles of Constitutional Order**. The legacy v12 → v13 crosswalk remains below for traceability; the change here is one of presentation, not of operative substance.
...
**Article IV — Survival**  
The Life Access Ledger as instrument and delivery path together. One definition, one attack surface; resolves the prior v12 semantic gap between LC-as-instrument and LC-as-delivery.

**Article V — Markets, Commons & Public Finance**  
Enterprise Currency (EC), land and housing use-rights, anti-monopoly enterprise, and Public Finance & Commons Revenue (PFCR) unified under one production-and-revenue article.

**Article VI — Civic Layer & Deliberation**  
Deliberation Weight (DW), Civic Record (CR), the contribution-recognition that mints them, and the deliberation processes they feed — the civic input-output pipeline as one article.
...
- Cannot be overridden by DW/CR/EC decisions or by operational expedience.
...
**Article IV — Survival**
- → LC issuance, daily allocation, and essential service delivery.
- Cannot condition survival on behavior; cannot permit LC monetization or conversion.

**Article V — Markets, Commons & Public Finance**
- → EC issuance and decay, housing and commons use-rights, enterprise competition, commons-revenue routing, and the public banking rail.
- Cannot allow instrument conversion, enable speculative rents, create monopolies, or tax survival or ordinary labor.

**Article VI — Civic Layer & Deliberation**
- → DW/CR minting, priority-setting, and authorized public decisions.
...
- **Scarcity interface:** during declared scarcity, Article V's SQ (Scarcity Quotas — a category-specific emergency rationing instrument, not money) may supplement LC allocation; termination rules bind SQ to the end of scarcity mode.
...
- **Use-rights governance:** housing and land are governed as use-rights/leases rather than speculative ownership. No individual or private entity may extract EC returns from residential use-rights.
- **Housing is non-profit infrastructure:** residential construction is funded through EC public infrastructure channels and project escrows; workers are compensated in EC, but the resulting units are held as commons and allocated as use-rights. No private housing market exists for residential units; allocation is managed by need and occupancy criteria, not price.
...
- **Quality is a civic investment, not an individual EC purchase:** housing quality improvements are funded at the neighborhood or district level through civic deliberation (Article VI) and public EC channels. Individual EC wealth does not entitle any resident to a superior private unit. No EC-priced private residential tier exists.
...
### Legacy and continuity mapping tables (reference)

**Current presentation note.** The live constitutional presentation uses **one Founding Order** and **seven Articles of Constitutional Order**. Historical `v13` shorthand (`P0`, `P1–P7`) and earlier `v12` pillar numbers survive below only for traceability.

| Current presentation | Legacy v13 shorthand | Notes |
| :--- | :--- | :--- |
| **Founding Order — Subsidiarity, Consent & Exit** | **P0. Subsidiarity, Consent & Exit** | Proposal 5 close-out — smallest competent scale, consent act, exit pathway. FC-120 (2/3), FC-121 (730-day unwind), FC-122 (scale tiers). |
| **Article I — Rights & Rule of Law** | **P1. Rights & Rule of Law** | Rights-definition and rights-execution are one function. S3* audit independence preserved via separation from Article VII. |
| **Article II — Personhood, Identity & Continuity** | **P2. Personhood & Continuity** | Unchanged in substance. |
| **Article III — Physics & Reserves** | **P3. Physics & Reserves** | Measurement and reserves are one capacity-function at different time-scales. |
| **Article IV — Survival** | **P4. Survival (LC Instrument + Delivery)** | Removes the semantic gap between LC-as-instrument and LC-as-delivery. |
| **Article V — Markets, Commons & Public Finance** | **P5. Markets, Commons & Public Finance** | Housing, enterprise, EC, and PFCR resolve under one economic article. |
| **Article VI — Civic Layer & Deliberation** | **P6. Civic Layer (DW/CR + Deliberation)** | Instruments, minting acts, and deliberation form one closed loop. |
| **Article VII — Transparency & Environmental Scanning** | **P7. Transparency & Environmental Scanning** | S3*/S3 institutional independence from Article I control. |

**v12 → current crosswalk (Proposal 2 close-out, continuity view).** The Twelve-Pillar structure was collapsed first into the v13 shorthand and is now presented publicly as a Founding Order plus Articles I–VII. Every substantive rule is preserved; the reorganization is by consolidation, not deletion.

| v12 (Twelve Pillars) | Current presentation | Notes |
| :--- | :--- | :--- |
| *(none — absent layer)* | **Founding Order — Subsidiarity, Consent & Exit** | Proposal 5 close-out — smallest competent scale, consent act, exit pathway. |
| **P1. Constitutional Invariants & Rights** + **P10. Operations, Oversight & Service Delivery** (execution portion) | **Article I — Rights & Rule of Law** | Rights-definition and rights-execution are one function. |
| **P2. Personhood, Identity & Continuity** | **Article II — Personhood, Identity & Continuity** | Unchanged in substance. |
| **P3. Resource & Capacity System (RCS)** (includes resilience reserves in-pillar) | **Article III — Physics & Reserves** | Measurement and reserves are one capacity-function at different time-scales. |
| **P4. Life Support Layer** + LC-instrument portion of **P5. Monetary Architecture** | **Article IV — Survival** | Removes the semantic gap T-007 drift attacks exploited. |
| EC-instrument portion of **P5. Monetary Architecture** + **P6. Land, Housing & Commons** + **P7. Enterprise & Production** + **P12. Public Finance & Commons Revenue (PFCR)** | **Article V — Markets, Commons & Public Finance** | Four faces of one economic surface consolidated. |
| DW/CR-instrument portion of **P5. Monetary Architecture** + **P8. Contribution & Capability Development** + **P9. Civic Deliberation & Decision Systems** | **Article VI — Civic Layer & Deliberation** | Instruments, minting acts, and deliberation form one civic loop. |
| **P11. Information Commons & Trust Transparency** + *(new Beer S4 scanning)* | **Article VII — Transparency & Environmental Scanning** | Adds the previously-absent environmental-scanning function. |
...
### 13. LC coercion or black-market conversion
- **Failure mode:** people buy/sell LC or force dependents to hand over LC, reintroducing survival coercion.
- **Patches:** LC non-transferable by default; tightly scoped caregiver transfers with caps; coercion-specific penalties; safe-report channels; anomaly detection on essential purchase patterns.
- **Residual risk:** barter cannot be eliminated; minimize incentives by guaranteeing baseline supply and keeping LC usable only for the essential basket.

### 14. Hoarding essentials as goods
- **Failure mode:** even if LC expires, goods can be stockpiled to gain leverage in scarcity.
...
### 15. EC demurrage avoidance via asset hoarding
...
- **Failure mode:** insiders create EC through fake payroll, circular invoices, indefinite continuity backstops, or political favoritism, allowing hidden stock creation even while the protocol claims money is flow-bound.
...
- **Failure mode:** a small class farms DW and CR advantages and dominates priorities, staffing, or oversight even with decay controls.
...
- **Failure mode:** fake hours or collusive approvals mint DW or CR illegitimately.
...
- **Failure mode:** multiple identities claim LC or unlawfully enter the civic layer at scale.
...
## V. Transition Outline (From Legacy to Protocol)
...
- **Foreign inflow controls:** convert external capital into EC subject to demurrage immediately, forcing productive deployment.
- **Trade membrane:** essential-capacity exports are capped to protect domestic LC guarantees.
...
**Morning:** Your LC refreshes for the period. You purchase essential food and transit. Any unused LC expires, so waste and hoarding incentives fall and mutual aid becomes easier within safe transfer rules.

**Work:** You earn EC through your enterprise role. Your employer reinvests rather than hoards because idle EC decays.

**Evening:** You allocate DW to a community project proposal while your CR standing keeps you eligible for future civic jury service. Because DW fades quickly and service eligibility is separated from agenda weighting, the system rewards stewardship without allowing permanent rule.

**Audit:** You are randomly selected for a civic jury. You review a flagged pattern suggesting bribery. The Immune System triggers an investigation while protecting innocent counterparties and ensuring due process.
...
### Visualization cues
- **Enterprise Currency (EC):** visualize as warming coals or circulating current (value decays if idle; thrives when circulating).
- **Civic layer (CC umbrella):** visualize as a pulse/heartbeat split into DW for short-horizon civic weighting and CR for service readiness. Avoid medals, ranks, or 'scores'.
- **Scarcity Quotas (SQ):** visualize as a clearly bounded emergency ration or reserve valve; temporary, category-specific, and never prestige-bearing.

### Option B snapshot
- **EC baseline (Option B):** demurrage of 0.5% per month on idle balances above the constitutional operating-float exemption; new EC is created only against verified productive commitments through Annex X channels, with dual-key review, audit-level provenance tagging, independent milestone controls for protected windows, and staged unwind rules to prevent hidden stock creation.
- **LC baseline (Option B):** daily micro-issuance with 72-hour rolling validity, anchored to the Constitutional Survival Minimum and the broader essential basket so survival continuity does not hinge on a single weekly redemption window.
- **Civic layer baseline (Option B):** DW uses a short quarterly cycle with caps, no rollover, and diminishing-returns weighting; CR preserves bounded service eligibility with hardship-safe continuity. Neither layer may be purchased, sold, inherited, or used to gate survival.
- **SQ baseline (Option B):** activated only during verified scarcity; category-specific; non-transferable except narrow caregiver channels; and terminated automatically when scarcity mode ends.
- **Housing/land baseline (Option B):** use-rights/leases with no private housing market for residential units; construction funded through EC public infrastructure channels with no EC return to any private party from the housing product itself. Allocation uses a published per-person floor scaled to verified household size up to a published household maximum cap; the commons does not expand allocation beyond the cap regardless of household composition decisions. Composition changes triggering space expansion require a minimum verification period before the increase is granted (births and documented medical emergencies exempt). Housing quality improvements are funded at the neighborhood or district level through civic deliberation, not individual EC purchase. Renewal based on occupancy and a closed-list stewardship standard limited to sustained vacancy beyond threshold, physical damage beyond normal wear, verified illegal activity tied to the premises, and clearly defined health/safety violations after remediation opportunity; anti-vacancy carrying costs; limits on accumulation of residential use-rights; strong anti-rent-seeking enforcement. Aesthetics, lifestyle, politics, relationships, visitor profile, household structure, and protected-trait proxies are prohibited bases for renewal denial or allocation weighting.
...
### Enterprise Currency (EC) - baseline settings
...
### Civic layer (DW + CR) - baseline settings
- **DW cadence:** short quarterly cycle with fast decay, no rollover, category balancing, and protected pause continuity so agenda influence remains kinetic rather than cumulative.
- **CR service path:** earned only through verified stewardship and service under Pillar 8; CR governs eligibility for juries, panels, rotating review, and oversight roles and may not be bought, sold, inherited, or institutionalized as patronage.
- **DW influence cap:** a per-person cap per quarterly decision cycle limits dominance even for high contributors; any survival-adjacent use remains advisory pending legitimacy safeguards.
- **Diminishing returns and sector balance:** DW uses a diminishing-returns curve and published sector ceilings so one legible professional class cannot dominate effective civic weighting.
- **Participation continuity:** verified caregiving, illness, disability disruption, disaster displacement, or involuntary unemployment may activate hardship-safe continuity in both DW and CR so temporary hardship does not erase civic standing.

### Scarcity Quotas (SQ) - baseline settings
...
- **Exit rule:** SQ terminates automatically when scarcity mode ends; repeated use triggers mandatory review of the underlying capacity failure and reserve strategy.
...
**LC scarcity-mode thresholds (per essential category)**
...
| :--- | :--- | :--- | :--- |
| **Delegated spend authority (preferred)** | No transfer; spend limited to dependent's own LC balance and basket categories | Verified caregiver relationship; scoped permissions; immutable logs naming beneficiary | Out-of-basket attempts; unusual vendor concentration; repeated high-value edge cases |
| **LC transfer (exception channel)** | Up to 10% of dependent's weekly LC entitlement (per week) | Allowed only when delegation is not available; requires reason code; 7-day expiry on transferred LC | Repeated transfers; multiple dependents -> same receiver; coercion pattern clusters |
| **Household pooling (shared address)** | Up to 20% of each adult's weekly LC into a household wallet | Verified shared residence; all members can revoke consent; pooled LC limited to basket categories | One-way pooling; rapid cycling; coercion indicators; revocation disputes |

**DW quarterly limits and CR service path**
Default DW cap: 300 raw DW allocatable per person per quarterly decision cycle, with no rollover. CR is maintained separately as the service-and-eligibility record used for juries, panels, rotating review pools, and oversight selection under published fit rules.

| Raw CC allocated in cycle | Weight multiplier | Effective CC credited |
| :--- | :--- | :--- |
| 0-50 | 1.00x raw | 50 |
...
Example: allocating 100 raw DW yields 50 + (30×0.5) + (20×0.25) = 70 effective DW.
Constitutional rules, rights, and survival access remain one-person-one-vote, and any survival-adjacent recommendation produced through DW remains advisory unless separately ratified through the legitimacy safeguards defined elsewhere.

**Oracle buffers and dispute defaults**
- **Issuance buffer:** issue 90% of computed LC baseline; retain 10% as a resilience buffer for shocks and model error.
...
- **Dispute window:** 14 days. Methodology-only disputes trigger audit and disclosure, not automatic LC tightening. A challenger must produce prima facie alternative measurement evidence within 48 hours to justify temporary issuance reduction, and cumulative dispute-driven reductions may not exceed 10% of baseline in any rolling 30-day window.
...
## ANNEX D. Supplemental Framework Questions and Pillar Enhancements
**Purpose.** This annex applies supplemental design prompts and external framework ideas (regenerative design, positive peace, trust, wellness, agile/lean execution) to stress-test and strengthen the Eight-Pillar Protocol. It does not add new rights-gating mechanisms; it adds measurement, safeguards, and execution discipline.

### D1. The five questions (asked and answered)

**Is it Regenerative?**
- **Does the system give back more than it takes over time (materials, ecology, social trust), or does it merely reduce harm?**
- **Resulting enhancements:** Add a 'Regenerative Mandate' to Pillar 1 and Pillar 5: budgets and production plans must include net-positive restoration targets (soil, water, energy, waste loops). Add Circularity requirements to Pillar 7 (Enterprise): extended producer responsibility, repairability, and take-back loops for durable goods. Add a Regeneration Scorecard (non-punitive) published quarterly.

**Is it Resilient?**
- **Does the system preserve stability under shocks (supply-chain disruption, disasters, conflict), especially through free flow of information and equitable distribution?**
- **Resulting enhancements:** Explicit 'Free Flow of Information' invariant: capacity data, scarcity indices, and decision outcomes are public by default (with privacy for individuals). Define 'Resilience Reserves' in Pillar 1. Add anti-corruption hardening: mandatory public procurement transparency.

**Is it Trusted?**
- **Are clarity, compassion, character, competency, commitment, connection, contribution, and consistency measurable and enforced as operating standards?**
- **Resulting enhancements:** Add a Trust Operating Standard for Pillar 6 (Operations): service-level commitments, publish/meet decision timelines. Add a 'compassion safeguard' to enforcement: freeze/penalty tools must avoid collateral harm to dependents. Add an annual Trust Review.
...
- **Resulting enhancements:** Add a Human Flourishing Dashboard (informational only): wellness indicators guide priorities but never gate survival or rights. Add burnout and workforce-sustainability protections in Pillar 6 and Pillar 4. Add community cohesion supports: time-banking and local stewardship projects.

### D2. Crosswalk to "Positive Peace" conditions (non-binding)
*These conditions are treated as system health signals and design checks. They do not override the protocol's core invariants.*

| Positive Peace condition | Primary protocol mapping | What we enforce / publish |
| :--- | :--- | :--- |
| **Well-functioning government** | Pillar 6 (Operations) + Pillar 8 (Immune System) | Execution without discretion; audited service delivery; controlled emergency powers. |
| **Sound business environment** | Pillar 7 (Enterprise) + Pillar 1 (Capacity) | Clear rules; predictable demurrage; capacity-anchored constraints; anti-rent-seeking. |
| **Equitable distribution of resources** | Pillar 2 (LC) + Pillar 1 | Universal survival floor; scarcity-mode fairness; transparent allocation logic. |
| **Acceptance of the rights of others** | Pillar 3 (Identity & Personhood) + Pillar 8 | Non-discrimination; due process; anti-coercion enforcement. |
| **Good relations with neighbors** | External Boundary Membrane (if adopted) + Pillar 6 | Trade interface with non-convertibility; diplomacy; security without extraction. |
| **Free flow of information** | Pillar 1 + Pillar 5 + Pillar 8 | Open capacity indices; transparent decisions; oversight access to logs. |
| **High levels of human capital** | Pillar 4 + Pillar 6 | Capability uplift; training pathways; safe/healthy work design. |
| **Low levels of corruption** | Pillar 8 + Pillar 6 + Pillar 7 | Randomized audits; procurement transparency; conflict rules; anti-cartel enforcement. |

### D3. Metrics (informational) and guardrails (enforceable)
**Rule:** informational dashboards inform priorities; enforceable guardrails constrain actions. Metrics must never become a backdoor social score.

**Dashboard Example indicators**
- **Regeneration Scorecard (Quarterly)** Energy mix, waste loops, water quality, ecosystem restoration, maintenance backlog.
- **Resilience Index (Monthly)** Days-of-supply, fill rate, critical dependency risk, reserve drawdown rate, recovery time.
- **Trust Index (Quarterly)** On-time execution %, audit findings closed, appeal outcomes, transparency compliance, incident recurrence.
- **Human Flourishing Dashboard (Quarterly)** Health access, safety, housing stability, education/training, environmental conditions, community cohesion (survey + objective measures).

### D3.1 Real-time public dashboards (privacy preserved)
This protocol uses real-time public dashboards for accountability and resilience, while preventing the dashboards from becoming surveillance or a backdoor social score.
- **Public by default:** aggregate indices (capacity, scarcity, reserves, regeneration, execution SLAs, anti-capture health metrics).
- **Private by default:** individual identity details, individual balances/transactions, individual health data, exact location trails, and any data that enables targeting or coercion.
- **Privacy preservation rules:** publish only aggregated metrics above a minimum group size (k-threshold); suppress small cells; apply time delays on sensitive categories; and use noise/rounding where needed to prevent re-identification.
- **Transparency rules:** publish dashboard definitions, data sources, refresh rates, and a public change log; allow independent audits and reproducible calculations where feasible.
- **Abuse-resistance:** rate-limit or delay the most gameable signals; monitor for dashboard-driven manipulation; and treat data disputes as triggers for conservative issuance and review.

### D4. Implementation checklist (Option B baseline)
- Operate real-time public dashboards with privacy-preserving publication.
- Implement procurement transparency and conflict-of-interest rules for all Control Owners.
- Stand up resilience reserves (food/water/energy/medicine) with clear replenishment rules.
- Adopt agile/lean operating loop: quarterly plan \-> execute \-> measure \-> patch; require post-mortems for major incidents.
- Add circularity rules to the Enterprise Platform (repairability/take-back) and track compliance.
- Add wellness protections in operational staffing to prevent systemic burnout.

---

## ANNEX E. Legacy 8-Pillar Requirements Checklist (Tagged)
**Note:** This annex retains the prior 8-pillar checklist for reference. For the legacy v12 checklist, see ANNEX F; for the current Founding Order + Articles I-VII presentation, see §III and the v12 → v13 mapping table.

**Purpose.** This annex converts the supplemental questions and enhancements into a practical checklist per pillar. Each item is tagged as: [I] Informational metric (dashboard/reporting only), [E] Enforceable guardrail, or [P] Implementation practice.

#### Pillar 1 - Resource & Capacity System (RCS)
- **[I]** Publish real-time capacity, scarcity, and reserve indices at the aggregate level. Dashboard uptime \>= 99.5%; definitions and refresh rates published.
- **[E]** Oracle quorum and dispute rules: contested data triggers conservative issuance and mandatory review. Audit logs; dispute tickets; issuance throttles tested.
- **[P]** Maintain resilience reserves (food/water/energy/medicine) with replenishment rules and redundancy planning. Reserve levels; replenishment drills; after-action reports.
- **[I]** Publish regeneration indicators (waste loops, energy mix, water quality, soil/ecosystem restoration) without individual attribution. Quarterly scorecard + real-time trend lines where safe.

#### Pillar 2 - Monetary Architecture (EC / LC / civic layer / SQ)
- **[E]** LC remains non-transferable by default; tightly scoped caregiver/dependent delegation with caps and coercion detection. Transfer cap rules; anomaly detection; protective interventions tested.
- **[E]** No convertibility: EC cannot purchase CC; CC cannot buy LC; LC cannot be traded for coercive power. Policy tests; enforcement playbooks; audit sampling.
- **[E]** EC demurrage on idle balances (Option B baseline: 1%/month) and anti-speculation measures on essential hoarding. Demurrage ledger tests; anti-hoarding triggers; enforcement proportionality review.
- **[I]** Publish distribution and concentration metrics for EC and CC (aggregate), including Gini-style indicators and top-percent share. Dashboard uses privacy thresholds; small-cell suppression.
- **[E]** CC decision cycle is quarterly with no rollover of influence. Quarterly decision window; results published; cap calculations.
- **[E]** Per-person CC cap and diminishing-returns weighting prevent civic aristocracy. Weighting curve specified; scenario simulations; audit.

#### Pillar 3 - Identity & Personhood
- **[E]** Proof-of-personhood resists Sybil attacks while remaining accessible (no paywalls, no exclusionary tech requirements). Enrollment funnel metrics; fraud rate tracking; accessibility audits.
- **[E]** Privacy by design: individual identity data is minimized, encrypted, access-controlled, and never exposed via public dashboards. Data minimization spec; access logs; red-team privacy tests.
- **[P]** Fast recovery and due process for account issues (lost credentials, fraud flags) without collateral harm to dependents. MTTR targets; recovery drills; appeal outcomes reported (aggregate).

#### Pillar 4 - Contribution & Capability
- **[E]** Contribution affects influence only; it never gates survival, rights, or personhood. Policy invariants; enforcement audits.
- **[E]** Anti-fraud controls: multi-attestation, random audits, verifier penalties, and collusion detection. Audit rates; verifier reputation; anomaly reports.
- **[I]** Publish workforce sustainability indicators (burnout risk, safety incidents, understaffing) at an aggregate level. No individual scoring; privacy thresholds; quarterly review.
- **[P]** Implement right-to-rest scheduling and safety standards for essential roles. Workload caps; incident post-mortems; staffing plans.

#### Pillar 5 - Civic Deliberation & Priority Setting
- **[E]** CC scope limits: CC influences priorities among vetted options but cannot change rights, survival access, or due process. Constitutional constraints; audit of decision types.
- **[P]** Use mixed mechanisms to reduce capture: randomized agenda slots, rotation, and conflict-of-interest rules. COI disclosures; rotation logs; agenda randomness verification.
- **[I]** Publish deliberation quality metrics (participation diversity, proposal throughput, outcome tracking) at an aggregate level where safe. Aggregate only; small-cell suppression; quarterly summaries.

#### Pillar 6 - Government Operations & Execution
- **[E]** Execution safety: staged rollouts, rate limits, and narrowly scoped emergency pause with time limits and post-mortems. Release checklists; pause drill; post-mortem template.
- **[P]** Operate quarterly outcome loop: plan -\> execute -\> measure -\> patch (aligned with CC quarterly cycle). Quarterly plan published; evidence of patches.
- **[I]** Publish trust/operations SLAs (uptime, response times, MTTD/MTTR) via real-time dashboards. SLA dashboard; incident registry (aggregate).
- **[E]** Procurement transparency and anti-corruption controls for Control Owners and contractors. Public procurement log; audit trail; sanctions policy.

#### Pillar 7 - Enterprise Platform
- **[E]** Circularity and repairability expectations for durable goods; take-back loops where appropriate. Compliance reporting; product standards; audits.
- **[E]** Competition integrity: anti-monopoly controls, open standards, interoperability requirements. Interoperability audit.
- **[P]** Incentivize regenerative production (waste reduction, clean energy, ecosystem restoration) through standards and project priorities. Scorecard alignment; project portfolio evidence.
...
#### Pillar 8 - Immune System (Oversight & Anti-Capture)
- **[E]** Targeted enforcement: no collective punishment; protect dependents; proportional remedies with due process. Case sampling; appeals; dependency safeguards.
- **[E]** Independent oversight with audit authority and public transparency reports (aggregate, privacy preserved). Audit schedule; published findings; remediation tracking.
- **[I]** Maintain a live threat register dashboard (aggregate) with control status, tests passed, and residual risk trends. Evidence links; test cadence; change log.
- **[P]** Run regular red-team exercises and publish patch notes (what changed, why, and how validated). Exercise reports; patch validation artifacts.
...
## ANNEX G. Constitutional Plumbing and System Durability
**Purpose.** This annex hardens the protocol where capture most often hides: rule hierarchy, external interfaces, adjudication, public finance, pricing mechanics, and failure handling. It does not alter the protocol’s non-negotiable invariants; it specifies how those invariants are preserved when the system changes, trades, disputes, funds, and degrades.

**Design principle:** the safer system is the one whose exceptions are few, legible, time-limited, and independently reviewable.

### G1. Rule Hierarchy and Amendment Classes
Every rule must be classified before adoption. Lower tiers may refine higher tiers but may never contradict them. Any disputed classification defaults upward until independent review confirms otherwise.

| Tier | What belongs here | Who may change it | Minimum threshold |
| :--- | :--- | :--- | :--- |
| **Tier 1 - Constitutional invariants** | Human dignity, due process, unconditional survival floor, EC/LC/CC/SQ non-convertibility, no social score, privacy limits, anti-capture boundaries. | Only through constitutional amendment. | Multi-cycle public notice, supermajority approval, independent constitutional review, cooling-off period, and explicit rights-impact statement. |
| **Tier 2 - Charter / statutory rules** | Pillar boundaries, residency rules, dispute classes, budget rules, oracle quorum standards, vendor obligations, emergency authorities. | Charter legislature / constitutional body within delegated scope. | Public proposal, impact review, supermajority vote, delayed effective date, and judicial challenge window. |
| **Tier 3 - Operational parameters** | Scarcity thresholds, audit cadence, reimbursement bands, dashboard refresh intervals, technical standards, regional implementation details. | Authorized operators within published ranges. | Public log entry, version control, independent auditability, and automatic sunset if emergency-raised. |
...
### G2. External Boundary Membrane 2.0
...
- **LC is domestic**, non-exportable, and never convertible into foreign money or EC balances.
- **DW and CR are non-transferable**, non-saleable, and have no external analogue; no foreign person or firm may purchase civic influence or institutional service eligibility.
- **EC may cross the boundary** only through registered gateways with public reporting, sanctions screening, and treaty compliance review.
...
| :--- | :--- | :--- | :--- |
| **Imports of essentials** | Settled through EC gateways or public procurement contracts tied to published resilience plans. | Foreign claims on LC issuance, automatic price pass-through into the LC basket, or creditor control of domestic survival access. | Strategic reserves, supplier diversity, emergency substitution plans. |
| **Exports / foreign sales** | Domestic producers may sell externally for EC through audited registries and tax-compliant settlement. | Hidden offshore settlement, shadow conversion of export proceeds into political power, or treaty carve-outs around disclosure. | Beneficial ownership registry, transfer pricing audits, anti-monopoly review. |
| **Foreign firms and investors** | Transactional EC wallets, lease/use-right contracts, and time-bounded operating permissions. | Acquisition of constitutional assets, ownership rights that bypass commons rules, or direct political financing. | Public registry, lease limits, conflict-of-interest controls. |
| **Tourism and temporary presence** | Visitors operate in EC only, except emergency humanitarian services delivered through the service layer. | Routine access to CC, LC wallets, or residency rights by payment. | Duration limits, residency verification, emergency-only humanitarian floor. |
...
| **Remittances and gifts** | EC may be sent outward from lawful earnings through declared gateways. | Outbound LC/CC transfer, bundled coercive labor contracts, or hidden cross-border compensation for civic acts. | Transaction reporting thresholds, labor review, anomaly detection. |

---

### G3. Justice, Appeals, and Constitutional Review
...
| **LC delivery / service access** | Service ombuds + rapid benefit review. | Regional administrative court with emergency relief window. | Immediate restoration, arrears/restitution, corrected routing, vendor sanctions. |
| **CC attribution / contribution verification** | Contribution registry review with verifier challenge file. | Independent civic adjudicator; constitutional review if structural bias is alleged. | Re-score, nullification of fraudulent attestations, verifier penalties, published correction. |
...
| **LC reimbursement model** | Baseline goods and services are reimbursed within a public reference band that is reviewed quarterly and can move only within pre-declared emergency ranges. | Price methodology publication and anti-gouging triggers. |
| **Vendor participation** | Vendors may accept LC reimbursement only if they meet service, quality, data, and continuity obligations. | License conditions, complaint tracking, mystery-shop audits. |
| **Premium vs baseline versions** | Vendors may sell premium EC variants, but the LC-redeemable baseline must remain meaningfully functional and non-degraded. | Bait-and-switch penalties and quality equivalence testing. |
...
| **Severe divergence / shortage** | If EC market prices diverge sharply from baseline bands, the system shifts to procurement, reserve drawdown, substitution, or temporary direct delivery rather than silently abandoning the floor. | Trigger thresholds, reserve plans, emergency review log. |

### G6. Failure-State, Rollback, and Dissolution Protocol
...
### G7. Related hardening annexes added in this revision
- **Monetary calibration and long-horizon capital (Annex J):** gives demurrage a theory, a review corridor, and a ring-fenced investment channel so productive build time is not punished as idle hoarding.
- **Basket governance and participation fairness (Annex K):** treats the essential basket as a recurring constitutional debate and reduces the civic participation trap for caregivers, informal workers, and hardship cases.
- **Judicial architecture and physical-reality measurement (Annexes L and M):** constitutes the review body and treats oracle design as a first-order constitutional problem rather than a supporting technical detail.
- **Transition, deployability, and reader scenarios (Annexes N and O):** expands the genesis pathway, names the preconditions for legitimate rollout, and gives new readers concrete operational examples.
...
### H1. Classes of change and single-subject discipline
Every change proposal must declare its class before deliberation begins. Misclassification is itself grounds for invalidation.
...
- **Public notice window:** 14 days.
- **Passage rule:** simple majority of the maintaining authority plus a published finding that no semantic effect exists.
- **Automatic block:** if any Constitutional Review Panel member, Ombuds Office, or 0.25% public petition alleges substantive effect during the notice window, the proposal is reclassified upward before further action.
...
### H3. Standing, petition rights, and who may challenge
...
### H5. Review timelines, remedies, and effect-of-judgment rules
...
### H6. Emergency limitations and anti-entrenchment rules
Emergency response may preserve continuity, but it may not silently rewrite the constitution.
- **Tier 1 invariants** are never amendable by emergency order.
- **Class H-2 rules** may be temporarily suspended, but not rewritten, only during a declared Level 4 or Level 5 systemic event and only when necessary to preserve survival continuity, identity continuity, or system integrity.
- **Any emergency suspension of a Tier 2 rule requires:** (a) a written necessity finding, (b) publication within 24 hours, (c) automatic judicial review within 72 hours, and (d) expiration after 30 days unless passed again through the ordinary H-2 process.
- **Any emergency adjustment of a Tier 3 parameter** expires after 21 days unless ratified in the next quarterly cycle.
- **No emergency measure** may be renewed more than twice for the same underlying incident without a public post-mortem and supermajority judicial approval.

### H7. Amendment workflow and evidence package
- **Step 1 - Filing:** publish class, sponsor, legal basis, plain-language summary, redline, and all required notes.
- **Step 2 - Notice:** open the required public notice window and maintain a public comment log with version history.
- **Step 3 - Stress test:** publish at least one adverse-case analysis and one worked example using realistic households, enterprises, and regions.
- **Step 4 - Review:** complete legality review, privacy review, and capacity / budget review before any vote is certified.
- **Step 5 - Ratification:** apply the class-specific voting math with full publication of tallies, regional splits, and invalidation reasons.
- **Step 6 - Cooling off:** delay effectiveness for the class-specific period so people can understand the result and seek review.
- **Step 7 - Sunset check:** every substantive H-1 or H-2 amendment must be reviewed after four quarters with published evidence on whether it improved outcomes without creating new capture paths.
...
Every person physically present must be assigned a status class for continuity, service routing, and due-process purposes. Status assignment may affect onboarding sequence and queue priority, but it may not be used to deny the humane floor defined below.
- **Core Resident** - a person with verified ordinary residence and settled membership in a region or the federation, entitled to ordinary LC access and full public-service routing subject to the protocol.
...
*No status class may be bought, sold, collateralized, or accelerated solely by EC holdings, gifts, sponsorship payments, land control, or employer leverage. Sponsorship may support evidence of placement capacity, but it does not create ownership over a person.*

### I2. Humane floor for all persons physically present
No person physically present may be left without a minimum continuity floor while status is determined or disputed. This floor is distinct from ordinary resident LC and exists to prevent coercion, prevent avoidable death, and preserve due process.
- **The humane floor includes** emergency food, potable water, sanitation access, urgent and stabilizing care, safe-shelter triage, violence protection, language access where practicable, and a written explanation of status decisions in understandable form.
...
- **The humane floor does not by itself** create immediate entitlement to ordinary LC balances, ordinary housing queue position, or DW/CR participation, unless a protected-entry or dependency rule below says otherwise.
...
- Provide the humane floor, immediate safety screening, anti-trafficking screening, and family-linkage screening.
- Open a status case and record only the minimum necessary data to preserve continuity and prevent duplicate claims.
- No ordinary DW or CR rights exist at this stage. Ordinary LC wallet issuance does not occur at this stage except where a protected-entry dependency rule explicitly requires it.
...
- The person may be authorized to work or provide services for EC under rules that prohibit employer captivity, document withholding, or coercive housing tie-ins.
...
- No binding DW participation exists at this stage, though public comment access may not be denied.
...
- Ordinary LC may begin at this stage only through one of three paths: protected-entry necessity, dependency continuity, or region/federated settlement assignment based on verified capacity. Otherwise the humane floor and stabilization supports continue until Core Resident activation.
...
- Core Residents receive ordinary LC eligibility, ordinary public-service routing, and access to the ordinary housing queue under the same published rules that govern other residents.
...
#### I4.5 Civic Standing activation and DW/CR eligibility
- Ordinary DW participation and CR earning or service eligibility begin only after four full quarters of verified Core Resident status plus completion of a published civic orientation and no unresolved fraud adjudication.
- No person may accumulate retroactive DW or CR for pre-activation time.
...
- Temporary Residents, Visitors, and persons still in provisional stages may speak, petition, and access public information, but they do not cast binding DW-weighted decisions or enter CR-governed service pools.
...
- No public invitation or labor-shortage pathway may waive the DW/CR waiting period, the anti-purchase rule, or the anti-surveillance rules.
...
- Ordinary LC issuance may pause after a published absence threshold, but reactivation must be simple when continuity evidence exists and no fraud finding is present.
...
- No region may sell, auction, or indirectly monetize residency status, settlement priority, or DW/CR activation.
- No residency or migration rule may reduce the humane floor below the minimum continuity obligations stated in this annex.
...
- Any amendment that changes onboarding classes, waiting periods, humane-floor minima, capacity declarations, or DW/CR activation rules is subject to the mandatory judicial review triggers in Annex H.

---

## ANNEX J. Monetary Calibration, Long-Horizon Capital, and Instrument Discipline
**Purpose.** This annex refines the monetary architecture where hidden economic failure would otherwise appear: demurrage theory, long-horizon investment, instrument naming discipline, and calibration rules. It does not alter the constitutional separation among EC, LC, the civic layer, and SQ; it clarifies how the system uses EC without punishing productive build time or silently recreating rent-seeking.

**Design principle: punish idle extraction, not patient production.**

### J1. Why EC uses demurrage at all
...
- **Primary target:** reduce the advantage of sitting on liquid EC purely to capture scarcity rents or political leverage.
- **Secondary target:** keep EC circulating through production, payroll, maintenance, and trade rather than parking indefinitely in inactive balances.
...
- **Default Option B rate:** 0.5% per month on idle EC above a published operating-float exemption.
...
- **Equivalence rule:** any asset or instrument above the household-safe-harbor threshold that functions primarily as a non-decaying store of value - including foreign currency, collectible portfolios, non-productive durable stockpiles, or equivalent wrappers - is subject to review for EC-equivalent carrying-cost treatment regardless of legal form.
...
- **Success signals:** lower inactive concentration, lower essential-goods speculation, healthy project starts, stable payroll timing, and no material collapse in average project duration.

### J3. Investment channel architecture (required, not optional)
Long-horizon enterprise is impossible if all held EC is treated as idle. The investment channel is therefore a constitutional subsystem, not a discretionary afterthought.
...
- **Term Finance Pools:** transparent lending pools that price risk in EC, publish loss rules, and cannot purchase LC access, DW influence, CR service eligibility, or housing queue priority.
...
- **Legal vocabulary** remains technical: Enterprise Currency (EC), Life Access Ledger (LC), the civic layer (CC umbrella, composed of Deliberation Weight (DW) and Civic Record (CR)), and Scarcity Quotas (SQ).
...
### M1. Measurement humility principle
...
- **Food capacity** must account for distribution, spoilage, transport, and storage constraints rather than gross production alone.
- **Health capacity** must distinguish licensed capacity, staffed capacity, continuity capacity, and surge capacity.
- **Every essential category** must publish what is measured, what is estimated, what is missing, and what the likely error bands are.

### M3. Scarcity activation evidentiary standard
A scarcity trigger must specify verifying authority, evidence class, threshold crossed, confidence band, duration assumption, and review date.
- **“Verified disruption”** is insufficient on its own. The protocol requires named evidence, named verifier, named challenge path, and named unwind condition.
- **Any authority** seeking to tighten LC access or activate SQ must publish why less restrictive continuity measures are insufficient.
- **Affected regions**, providers, ombuds, and qualifying public petitions may challenge scarcity findings on expedited timelines.

### M4. Oracle failure defaults
- **Uncertain data** may justify conservative expansion restraint, but not silent deprivation.
- **In dispute**, the system defaults toward continuity of humane-floor obligations and slower tightening; if conservative issuance pushes any affected essential category below 85% of published baseline for more than 7 consecutive days, provisional narrow SQ activates for that category unless an expedited review body issues a written block with alternative continuity measures.
...
### N1. Minimum preconditions before launch
- **A cross-ideological legitimacy coalition** willing to submit itself to published constraints rather than governing by emergency charisma.
...
- **Public education materials** sufficient for ordinary people to understand EC, LC, the civic layer (DW/CR), SQ, rights, appeals, and basic onboarding.

### N2. Genesis governance (first 90 days)
- **Days 0-30:** debt-collection standstill for essentials-linked households; continuity guarantees for food, shelter, care, transit, and emergency mental health stabilization; publication of initial basket v0; publication of initial EC supply formula and conversion map; appointment by mixed lot of provisional CRP and provisional oracle quorum under founding-exclusion rules, external observers, and a public challenge window. The provisional CRP has zero Tier 1 authority during this window.
- **Days 31-60:** shadow accounting in selected pilot regions; publish stress tests; open comment and challenge windows; complete conflict screening for provisional institutions; prohibit major asset privatizations during founding window.
- **Days 61-90:** limited live cutover by region or sector only after readiness gate sign-off, public red-team report, and emergency manual fallback verification.
- **Any genesis institution** formed by appointment rather than ordinary process must sunset or face re-authorization through published review within eight quarters; no founding decision is permanent merely because it happened first.

### N3. Founding anti-capture rules
- **No single incumbent ministry**, bank coalition, major landlord bloc, major platform, dominant essential-goods vendor network, or donor bloc may nominate or control a majority of any provisional founding body.
- **Founding decisions** about the initial basket, initial EC supply, first oracle quorum, and first review institutions require recorded reasons, minority reports, and public challenge windows.
- **Large legacy creditors**, dominant landlords, and major essential-goods vendors must be subject to heightened conflict disclosure during genesis.
- **The protocol must admit** when a founding compromise is provisional rather than pretending it is eternal truth.

### N4. Transition honesty and deployability
The protocol is not deployable merely because it is internally coherent. It becomes deployable only when legitimacy, continuity capacity, and review capacity exist simultaneously.
- **If preconditions are absent**, the correct action is phased groundwork - institution building, public education, local pilot systems, and capacity mapping - not false full-rollout theater.
- **Every rollout plan** must name what political struggle, coalition-building, or civic preparation is still missing. Silence on this point is itself a design failure.

---

## ANNEX O. Reader Scenarios and Authority Map
**Purpose.** The protocol should not require new readers to reverse-engineer the system from abstractions alone. These scenarios make the architecture concrete and show which annexes govern difficult edge cases.

### O1. Small manufacturer building a new workshop
- The enterprise receives EC, not LC, for payroll and materials. Ordinary operating float is exempt from idle decay up to published levels; larger long-horizon build funds move into a project escrow under Annex J.
- The project escrow is milestone-audited, time-bound, and non-convertible into civic weight or essential entitlements. If milestones stall or funds are diverted, special treatment ends.
...
- The caregiver retains humane-floor protections through LC continuity and may seek a Protected Pause Window under Annex K so prior DW and CR are not wiped out during the crisis. Verified hardship preserves proportionate civic continuity; anti-concentration decay for high balances applies to ordinary inactivity, not documented incapacity or caregiving emergency.
...
### O3. Region claims housing scarcity
- The region must publish evidence class, capacity definition, challenge path, and unwind condition under Annex M. Counting uninhabitable or unstaffed units as placeable capacity is prohibited.
- Affected persons may challenge the declaration on expedited review; false or discriminatory scarcity is a constitutional violation.
- **Relevant authorities:** Articles III, V, and VII, Annexes I and M, and Annex L for review.
...
### Q4. Political realism and resistance mapping
- Every rollout plan must identify the incumbent actors likely to resist: legacy banks, dominant landlords, incumbent platform firms, high-rent monopolies, and any bureaucracy that benefits from opacity.
- Transition plans must name the mechanism by which these actors are being constrained: negotiated submission, legal override, competitive displacement, or deliberate non-participation.
- If a rollout plan cannot name how resistance is being handled, the plan is incomplete by definition.

---

## ANNEX R. Protected Capital Classes and Motivation for Excellence
**Purpose.** Demurrage is an anti-hoarding instrument, not a ban on patient capital. This Annex defines protected capital classes and clarifies how the protocol supports long-horizon excellence without reintroducing wealth-to-power conversion.
...
- The CRP shall include a primary panel and a reserve pool selected through staggered sortition from an eligibility pool screened for conflicts, competency thresholds, and recent political or financial entanglement.
- Terms must overlap and rotate so no single founding wave or transient coalition can dominate the whole panel.
- No member may serve consecutive terms beyond the published limit, and cooling-off periods apply before service in regulated institutions or elected office.

### S2. Classification and downgrade safeguards
- Any downward classification of a proposed rule change - for example, treating a Tier 2 or Tier 1 issue as Tier 3 - requires a supermajority of the full sitting panel.
- If the panel is materially split on classification, the rule auto-escalates upward pending external review rather than drifting downward by default.
- Minority opinions must be published whenever classification is disputed, and dissent automatically extends the public challenge window.

### S3. Capture indicators and forced review
- Repeated pro-incumbent outlier rulings, undisclosed contact patterns, synchronized financial conflicts, or abnormal dissent suppression trigger mandatory capture review.
- A capture review may be triggered by the Ombuds Office, an oversight supermajority, a defined public petition threshold, or an internal CRP minority bloc.
- During capture review, the CRP may not approve any downward classification or emergency constitutional suspension unless an external mixed panel concurs.

### S4. Constitutional failure recovery ladder
- **Stage 1 - Freeze:** contested reclassifications and emergency exception expansions pause automatically.
- **Stage 2 - Substitute review:** a temporary mixed review body drawn from reserve members, regional courts, and citizen-auditor slots hears only the disputed class of cases.
- **Stage 3 - Reconstitution:** if capture is confirmed, the CRP is partially or fully reconstituted under emergency anti-capture rules and public scrutiny.
- **Stage 4 - Refounding trigger:** if constitutional review itself cannot be restored within the published recovery window, Annex H refounding pathways become available.
...
### T3. Scenario class C - civic-layer capture attempt during emergency SQ extension and CRP split
- Test whether emergency scarcity tools unwind on time even when politically useful to keep.
- Test whether disputed DW or CR rule changes auto-escalate rather than being smuggled through crisis conditions.
- Test whether CRP minority dissent and substitute review function under timed emergency pressure.

### T4. Scenario class D - issuance capture plus unwind shock plus membrane leakage
- Test whether fake payroll, circular project finance, or politically concentrated issuance can be detected before newly created EC escapes into non-productive stores or offshore routes.
- Test whether unwind logic protects wage earners, essential providers, and innocent counterparties while still correcting mis-issuance quickly enough to preserve trust.
- Test whether channel ceilings, affiliate aggregation, and fairness dashboards force early constitutional review when issuance begins to privilege one sponsor class or region.
...
- The boundary membrane does not eliminate foreign pressure. It contains it through explicit treatment: negotiated submission, staged settlement, deliberate non-participation, or lawful override depending on category.
- No full domestic cutover may be certified while foreign-obligation treatment remains materially undefined for essential imports, reserve assets, or pension-critical holdings.
...
## ANNEX W. Worked Identity Paths and Hard Cases
**Purpose.** Annex P defines the tradeoff framework. This Annex shows how the non-biometric primary path works in hard real-world cases so implementation pressure does not invent bad shortcuts later.

### W1. Stateless person with no formal civil registry trail
...
- Core Resident activation requires layered corroboration over time - for example, repeated service contact, stable locality evidence, independent witness renewal, and adverse-claim challenge window - rather than a single impossible document demand.
...
### W4. Undocumented long-term resident in a low-trust community

---

## ANNEX X. EC Issuance Architecture
**Purpose.** The protocol cannot be capture-resistant if the point of money creation remains vague. This annex defines how EC comes into existence, who may authorize it, how issuance is bounded, and how issuance abuse is red-team tested. Where Annex X conflicts with looser issuance language elsewhere, Annex X governs.

**Design principle: issue EC against verified productive commitments, not against discretionary stock politics or financial privilege.**

### X1. What EC issuance is for
EC issuance exists to meet real productive demand: payroll settlement, milestone-bound project build-out, essential-services procurement, public infrastructure delivery, and tightly bounded continuity backstops during payment-system failure. EC is not created to reward political allies, inflate asset prices, rescue failed speculation without conditions, or manufacture demand without linked capacity, delivery, or maintenance need. Any issuance channel must identify the concrete activity, continuity need, or productive commitment it is serving. Purpose ambiguity is itself a constitutional defect.

### X2. Flow-based issuance rule and provenance
New EC may be issued only against verified productive commitments rather than as a prior discretionary stock. The protocol treats money as a flow linked to work, provisioning, maintenance, and build-out, not as a sovereign hoard.
...
- **All newly issued EC** carries provenance tags at the audit layer. EC remains user-fungible for ordinary market activity, but issuance source, channel, sponsor, and unwind status must remain visible to authorized oversight, post-mortem, and anti-capture review.
...
- **Unused, stale, or materially misdirected issuance** enters quarantine review. EC created for a declared purpose may not drift indefinitely into idle accumulation without reclassification, reversion, or formal protected-capital qualification.

### X3. Authorized issuance channels

**Payroll channel:**
EC may be created against verified net payroll obligations due within a short published window. Requests must reconcile headcount, compensation schedule, prior payroll float, and ordinary available EC. Unused payroll issuance automatically reverts or is quarantined after the payroll window closes.

**Project escrow channel:**
Approved project escrows may activate EC for facilities, tooling, R&D, housing construction, maintenance backlogs, and grid or water upgrades only through preregistered milestone tranches. Full upfront spendable issuance is prohibited absent explicit emergency authorization.

**Essential-services procurement channel:**
Essential-provider reimbursement, emergency logistics, and continuity-critical procurement may activate EC only when tied to purchase orders, delivery obligations, or receipt-confirmed service windows. Advance issuance is capped and must convert to delivered-status accounting quickly.
...
No single ministry, central bank analogue, private bank, donor-backed vehicle, or political office may unilaterally create EC. Issuance authority must be polycentric, rule-bound, and reviewable.
...
- **Any asset or instrument** that functions as a non-decaying store of value above the household-safe-harbor threshold is subject to equivalence review for EC-like carrying costs regardless of label, wrapper, or legal form.
...
- **Mis-issued EC** may be quarantined, reclassified, or unwound only through published procedures that minimize collateral harm to payroll recipients, essential providers, and innocent counterparties. No ordinary clawback may target wage earners or essential-service recipients absent fraud findings tied to them directly.
...
- Test whether shell employers, fabricated staff rosters, or recycled wage obligations can mint EC.
...
- Test whether affiliates can rotate invoices, declare vague milestones, or warehouse EC inside protected project structures.
...
**Red-team scenario 6 - Offshore leakage and non-EC parking:**
- Test whether newly issued EC is rapidly converted into foreign stores, art, collectibles, or durable stockpiles to escape demurrage.
...
- **Temporary substitution** is allowed only when functional equivalence is demonstrated and continuity of the humane floor is preserved for those already relying on the prior form of provision.

### Y2. LC daily micro-issuance
LC no longer expires as a single weekly cliff. The weekly baseline is divided into daily tranches, with each daily tranche carrying 72-hour rolling validity.
- **This model preserves anti-hoarding discipline** while smoothing demand, reducing end-cycle panic purchases, and limiting the black-market extractable value of any momentary LC balance.
...
- **Where a household pooling mechanism exists**, pooling caps apply at the household level as well as the individual level. Pooling may not recreate concentrated managerial control over large LC balances through household scaling alone.
...
This annex converts the prior single-ledger CC model into a two-track civic layer. Wherever earlier sections refer to “CC” for quarterly agenda weighting or bounded budget prioritization, they should now be read as referring to Deliberation Weight (DW). Wherever earlier sections refer to service eligibility, jury selection, review pools, panel participation, or oversight readiness, they should now be read as referring to Civic Record (CR). The term “CC” survives only as an umbrella label for the civic layer as a whole. This refactor is intended to reduce hierarchy reproduction, lower the stakes of ordinary civic weighting, and prevent one concentrated civic balance from simultaneously dominating agendas and institutional service pipelines.
...
### Z3. Civic Record (CR)
CR is the slower-moving civic service record that tracks whether a person has demonstrated enough verified stewardship to serve in rotating institutional roles without turning ordinary survival or public dignity into a performance contest.
- **CR governs eligibility** to serve on juries, citizen panels, rotating audit pools, review boards, and oversight bodies defined elsewhere in the Protocol.
- **CR is earned** through verified stewardship, skill development, and service, but it is not a moral rank and may never be used to deny LC, housing continuity, or personhood protections.
- **CR decays more slowly than DW** and may preserve a hardship-safe continuity floor during approved pause windows.
- **CR may not be traded**, inherited, pooled by institution, or proxied through enterprises or associations.

### Z4. Category balance and anti-meritocracy rule
To reduce the risk that one legible professional class captures the civic layer, no single contribution category may constitute more than 40% of the effective DW counted in any quarterly deliberation cycle, and no single sector may dominate more than the published ceiling of seats in any CR-governed service pool.
...
### Z5. Dual-key legitimacy for survival-adjacent decisions
Any recommendation produced through DW that materially affects the essential basket, housing baseline rules, LC redemption continuity, or residency dignity floor is advisory only until it also clears the legitimacy safeguards already established elsewhere in this Protocol. The civic layer may inform stewardship tradeoffs; it may not, by itself, decide who bears survival risk. This annex therefore reaffirms that one-person-one-vote legitimacy remains primary for constitutional questions and any decision that would narrow or condition the humane floor.

### Z6. Transition rule Implementation
Implementation may phase this refactor in by preserving historical “CC” records as seed CR balances while minting DW prospectively under the quarterly rules. No historical civic balance may be converted into ordinary wealth, survival privileges, or hereditary standing during this transition.

---

## ANNEX AA. Founding Constitutional Assembly, Pre-Announcement Membrane Construction, and Knowledge Commons

### AA1. Founding Constitutional Assembly
The founding period shall be anchored in a purpose-elected Constitutional Assembly rather than in a purely technocratic provisional body. The Assembly exists to provide democratic legitimacy for the foundational text, the first CRP selection process, and the initial anti-capture operating constraints.
- **Mandate:** ratify the founding constitutional text, authorize the first CRP selection through a published sortition process, and the first transition gates, and dissolve.
- **Term:** fixed at 18 to 24 months with no ordinary extension.
- **Eligibility firewall:** Assembly members may not hold a CRP seat or senior protocol office for 4 years after Assembly dissolution.
- **Technical expertise:** legacy-system experts may advise under conflict disclosure but may not control founding decisions by virtue of advisory status.
- **Sunset rule:** any founding decision taken by provisional bodies auto-expires after 8 quarters unless ratified through ordinary constitutional channels.
- **During the founding window**, the provisional CRP has process-protection authority only. It may screen for obvious Tier 1 violations, conflict breaches, and classification defects, but it may not permanently redefine Tier 1 meaning or authorize irreversible constitutional narrowing before ordinary institutions are live.

### AA2. Pre-announcement membrane construction phase
Before any public announcement of full conversion to the protocol’s monetary architecture, the system must complete a membrane construction phase under existing legal authority. This phase exists to reduce the announcement-to-flight seam identified in prior reviews.
- **Gateway licensing**, beneficial-ownership reporting, anti-circumvention review rails, and external settlement controls must be operational before conversion announcement.
- **The obligation-classification body** that distinguishes speculative, mission-critical, protected, and transition-sensitive claims must be constituted before announcement and must publish its conflict rules in advance.
- **No conversion announcement** may proceed until the membrane readiness checklist, legal basis, and enforcement staffing minimums are certified through the transition gates defined elsewhere in the Protocol.
...
**Purpose.** This addendum preserves continuity with the predecessor drafts while improving legibility for readers moving from the earlier 3-currency / 7-pillar framing into the later v12 corpus and current v13 architecture.

**Legacy-to-current mapping**
- The earlier 3-currency model is now expressed as one true currency (EC) plus three bounded non-money instruments or layers: LC, the civic layer (DW + CR), and SQ.
- Earlier references to CC should be read as the civic layer unless a clause explicitly distinguishes Deliberation Weight (DW) from Civic Record (CR).
...
# The Humane Constitution — Session 2 Hardening Clauses
...
The following clauses extend Annex M (Oracle, Physical Reality, and Measurement Limits), Annex U8 (Dispute-Deprivation SQ Bridge), and the LC scarcity-mode threshold table.

#### AC2.1 Sentinel Indicator Mandate
Every essential category on a periodic audit cycle must maintain at least one sentinel indicator — a faster, lower-fidelity signal capable of providing early warning without replacing the full audit. Sentinel indicators do not trigger SQ activation; they trigger expedited oracle review only.
...
- **Prohibited:** Activate full SQ — requires oracle confirmation. Narrow humane floor access below 85% of baseline. Affect any category other than the one named in the trigger. Extend beyond 72 hours without oracle confirmation.

**Oracle confirmation outcomes:**
If oracle confirms crisis: full SQ activates; PCRP is superseded; oracle process governs. If oracle contradicts (supply is adequate): PCRP immediately terminates; full issuance restored; mandatory post-mortem published within 7 days; activation is logged as a false trigger. Three false PCRP activations within four quarters by the same Regional Executive Body triggers mandatory independent audit of that body's measurement access and decision process.

#### AC2.3 SQ Unwind Symmetry — Recovery Fast-Track
When a sentinel indicator shows sustained recovery signals for 48 hours after a scarcity declaration, the oracle must publish within 24 hours whether SQ should unwind. The conservative default bias established in Annex M applies to SQ activation; it does NOT apply to prolonged restriction after unambiguous recovery signals. The burden of demonstrating continued scarcity rests on the authority resisting unwind, who must publish alternative continuity measures with equal or better protection. This rule is symmetric with PCRP: what can be activated quickly can be deactivated quickly on equivalent evidence.

#### AC2.4 Cadence-Adjusted U8 Bridge (Supersedes Annex U8)
Annex U8 is amended as follows. The 7-day trigger is replaced by a volatility-class-adjusted trigger: for High-volatility essential categories, if effective LC falls below 85% of the normal baseline for more than 48 consecutive hours, this automatically constitutes a provisional scarcity finding sufficient to activate narrow SQ for that category. For Medium-volatility categories, the 7-day trigger from Annex U8 is retained. For Low-volatility categories, the 7-day trigger from Annex U8 is retained. All other conditions and constraints of Annex U8 remain in force.
...
#### AC3.2 CR Sector Ceiling Specification — Founding Precondition
CR sector pool ceiling values must be specified and published before any implementing body is constituted. This is a founding precondition under Annex N. The following baseline values apply unless superseded by the founding constitutional body through the amendment process:
- No single contribution sector may hold more than 25% of seats in any CR-governed service pool (juries, audit pools, review boards, oversight bodies).
- No cross-sector cluster identifiable by shared institutional origin — defined as same employer type, same training program cohort, or same founding working group — may hold more than 35% of seats in any CR-governed service pool.
...
The deadlock resolution timeline applies only to the FAP PROPOSED→ACTIVE pathway. Emergency provisional activation under Annex C-6 remains a separate pathway for genuine operational emergencies and is not affected by FAP deadlocks.
...
### AH1. Nature and Scope of P-014
P-014 is not a standing patch. It is a one-time founding instrument with a single defined purpose: activating P-013. Upon P-013 reaching ACTIVE status, P-014 closes permanently and irrevocably. The following constraints are Tier 2 protected and cannot be removed without H-2 amendment process:
- P-014 applies only to P-013. It cannot be invoked for any other patch, instrument, or governance action.
- P-014 cannot be cited as precedent or authority for any future activation, exception, or urgency bypass.
...
| :--- | :--- | :--- |
| **Threat Register Owner** | Ex officio | Must disclose all contributions to P-013 design; serves as primary evidence presenter, not adjudicator. |
| **CRP Reserve Member** | Lot-drawn from reserve pool | Must not have been involved in any stage of P-013 design or review. |
| **External Systems Reviewer** | Nominated from outside design-team domain | Primary professional expertise must be in a domain not represented in the P-013 design team. |
| **Ombuds Office Officer** | Ex officio — Ombuds designee | Standard Ombuds conflict screening applies. |
| **Public-Interest Advocate** | Lot-drawn from founding petition pool | Must not be affiliated with any institution that co-designed or funded P-013 design work. |

- All five members must attest that they have not co-published, co-presented, or held institutional affiliation with any P-013 design team member in the past 5 years. Attestations are externally verified, not self-reported.
- One panel member must have a documented professional history of arguing against process-hardening mechanisms — specifically someone who has publicly criticized similar acceptance process designs. Their full written dissent is published regardless of the panel's overall vote.
...
- P-013 moves to ACTIVE status.
- P-014 closes permanently and cannot be re-invoked.
...
- Were the desk-review cases selected to confirm or to challenge P-013?
- Did the adversarial red-team analysis identify all material weaknesses, or were critical gaps missed?
- Does the activation record contain any undisclosed dependencies or side agreements?
...
### AH8. Complete Threat/Patch Linkage — All Sessions
